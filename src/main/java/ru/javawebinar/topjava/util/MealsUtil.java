...
public class MealsUtil {
    ...
    public static List<Meal> getMealsList() {
        return Arrays.asList(
                new Meal(1, LocalDateTime.of(2019, Month.MAY, 30, 10, 0), "Завтрак", 500),
                new Meal(2, LocalDateTime.of(2019, Month.MAY, 30, 13, 0), "Обед", 1000),
                new Meal(3, LocalDateTime.of(2019, Month.MAY, 30, 20, 0), "Ужин", 500),
                new Meal(4, LocalDateTime.of(2019, Month.MAY, 31, 10, 0), "Завтрак", 1000),
                new Meal(5, LocalDateTime.of(2019, Month.MAY, 31, 13, 0), "Обед", 500),
                new Meal(6, LocalDateTime.of(2019, Month.MAY, 31, 20, 0), "Ужин", 510),
                new Meal(7, LocalDateTime.of(2019, Month.JUNE, 01, 10, 20), "Завтрак", 900),
                new Meal(8, LocalDateTime.of(2019, Month.JUNE, 01, 13, 0), "Обед", 700),
                new Meal(9, LocalDateTime.of(2019, Month.JUNE, 01, 20, 0), "Ужин", 540),
                new Meal(10, LocalDateTime.of(2019, Month.JUNE, 02, 10, 20), "Завтрак", 500),
                new Meal(11, LocalDateTime.of(2019, Month.JUNE, 02, 12, 10), "Обед", 1300),
                new Meal(12, LocalDateTime.of(2019, Month.JUNE, 02, 20, 15), "Ужин", 440)
        );
    }
